...
--- Find the change in employee status  --- by using full pouter join 
select * from emp_2020 
select * from emp_2021 

	select isnull(e20.emp_id,e21.emp_id)as emp_id ,e20.designation,e21.designation,
	case when e20.designation != e21.designation then 'promoted ' 
	when e21.designation is null then 'resigned'
	else 'New ' end as comment 
	from emp_2020 e20 full outer join emp_2021 as e21 
